...
class HybridPlanningLearningAgent:
    ...
    def learn_operator(self, grounded_operator:fs.Action, executed_operators:List[fs.Action]=[]):
        ...
        learner = learning.learner.LLMSubgoalCurriculumLearner(env=env_copy, domain=self.domain, rl_algo=args.rl_algorithm, grounded_operator_to_learn=grounded_operator, executed_operators=executed_operators, config=self.config)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--baseline', action='store_true', help='use the baseline hybrid planning learning agent')
    parser.set_defaults(baseline=False)
    parser.add_argument('--domain', default='kitchen', type=str, help='name of the domain. Can be either `nut_assembly`, `coffee` or `cleanup`')
    parser.add_argument('--rl_algorithm', default='SAC', type=str, help='name of the reinforcement learning algorithm to use. Can be either `PPO`, `SAC`')
