...
class CoffeeDrawerDetector(Detector):
    ...
    def exclusively_occupying_gripper(self, tabletop_obj:str, gripper:str) -> bool:
        ...
        if tabletop_obj == 'drawer':
            tabletop_obj_contact_geoms = ['DrawerObject_drawer_handle_2'] # make the middle handle the only contact geom to avoid faulty grasp detection
